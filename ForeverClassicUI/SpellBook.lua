...
local function BuildBook()
    ...
    -- "Page N" between the two arrows, gold and centred (Era's XML also
    -- carries an older brown one low on the right that never showed; the
    -- one drawn is this)
    book.pageText = book:CreateFontString(nil, "OVERLAY", "GameFontNormal")
    book.pageText:SetSize(102, 0)
    book.pageText:SetJustifyH("CENTER")
    book.pageText:SetPoint("BOTTOM", book, "BOTTOM", -14, 96)
