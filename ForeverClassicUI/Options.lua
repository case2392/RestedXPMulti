...
local LABELS = {
    ...
    questlog = "Classic quest log (Era's parchment and font on the quest side of Forever's map window)",
    collections = "Classic framing on the Appearances window (Era parchment, title and tabs; Era had no transmog)",
